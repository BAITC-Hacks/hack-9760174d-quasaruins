...
**Playable checkpoint:** a full-screen miniature of Astana on a white canvas, with contrasting architectural facades, 60 representative existing service buildings, mapped landmarks and parks, moving cars/pedestrians, and construction replay. Fourteen illustrated project cards form an open scrollable arc; hover or keyboard focus highlights the affected map regions and services. Exact results, a timeline chart, pinned Plan A comparison, a grounded AI briefing and optional narration work through the same planning flow.
